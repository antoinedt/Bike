 ...
 *
 * When a MapTiler key is available (entered in-app or built in) we hand-build a
 * style JSON that turns on the things that make the scene feel real and
 * three-dimensional:
...
object MapStyle {
    ...
    fun styleJson(key: String): String {
